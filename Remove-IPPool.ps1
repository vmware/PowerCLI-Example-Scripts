Function Remove-IPPool {
    ...
    Process {
        ...
        $dcenter = New-Object -TypeName VMware.Vim.ManagedObjectReference
        ...
        $SelectedPool = ($IPPoolManager.QueryIpPools($dc.ID) | Where-Object -FilterScript { $_.Name -like $PoolName })
